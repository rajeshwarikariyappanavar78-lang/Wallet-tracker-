...
const initialExpenses = [
  { id: 1, title: "Grocery run", amount: 62.40, category: "Food", date: "2026-05-01" },
  { id: 2, title: "Monthly Netflix", amount: 15.99, category: "Entertainment", date: "2026-05-02" },
  { id: 3, title: "Bus pass", amount: 35.00, category: "Transport", date: "2026-05-03" },
  { id: 4, title: "Dentist visit", amount: 120.00, category: "Health", date: "2026-05-04" },
  { id: 5, title: "New sneakers", amount: 89.99, category: "Shopping", date: "2026-05-05" },
];
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontSize: 28, fontWeight: 700, letterSpacing: "-0.5px" }}>Spendr</div>
        </div>
        <div style={{
